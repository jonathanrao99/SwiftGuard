...
const configurations: Record<Environment, EnvironmentConfig> = {
  development: {
    ...
    ID_ANALYZER_SERVER_API_KEY: Constants.expoConfig?.extra?.ID_ANALYZER_SERVER_API_KEY || '',
    ID_ANALYZER_RESTRICTED_API_KEY: Constants.expoConfig?.extra?.ID_ANALYZER_RESTRICTED_API_KEY || '',
